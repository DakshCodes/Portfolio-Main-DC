...
import profile from '../../public/images/profile/dakshprofile.jpg'
    ...
    return (
        <>
            ...
            <main className='flex w-full flex-col items-center justify-center'>
                <Layout className='pt-7 pb-10'>
                    <AnimatedText text="Passion Fuels Purpose!" className='mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8' />
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                            <h2 className='mb-4 text-lg font-bold uppercase text-dark/75 '>Biography</h2>
                            <p className='font-medium'>
                                Hi, Iam Daksh Singh, a web developer and Designer with a passion for creating beautiful, functional,
                                webapp , iam in 2nd year with multiple real world projects  in the field. I am always looking for
                                new and innovative ways visions to life.
                            </p>
                        ...
                        <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3' >
                            ...
                            <div className='flex flex-col items-end justify-center'>
                                ...
                                <h2 className='text-xl font-medium capitalize text-dark/75 xl:text-center md:text-lg sm:text-base xs:text-sm'>Startup Experiance</h2>
                            </div>
                        </div>
